...
def test_egyedi_betuk():
    ...
    assert egyedi_betuk("Helo, Világ!") == ['e', 'g', 'h', 'i', 'l', 'v', 'á', 'ó']
...
export function test_egyedi_betuk() {
    ...
    console.assert(equals(egyedi_betuk("Helo, Világ!"), ['e', 'g', 'h', 'i', 'l', 'v', 'á', 'ó']),"Helo, Világ!");
    ...
    console.assert(equals(egyedi_betuk(""), []));
console.assert()
